...
//Add Privacy - Photo Library Additions Usage Description to info.plist -> Value : "WE need to work with your photos"
//Two delegates required for UIImagePickerController
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @objc func applyProcessing() {
        ...
        //Since you used guard let, you can remove ! force unwraps later on by
        //replacing with temp variable 'outputImage'
